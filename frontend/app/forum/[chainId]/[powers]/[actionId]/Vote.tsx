          ...
          <div className="space-y-2">
            ...
            <div className="flex flex-col gap-2">
              <button
                ...
                className="w-full border  px-4 py-3 text-xs transition-colors bg-green-500/20 border-green-500 text-green-500 hover:bg-green-500/30 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer font-mono uppercase tracking-wider"
              >
              ...
              <button
                ...
                disabled={status.status === "pending"}
                className="w-full border  px-4 py-3 text-xs transition-colors bg-red-500/20 border-red-500 text-red-500 hover:bg-red-500/30 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer font-mono uppercase tracking-wider"
              >
              ...
              <button
                ...
                disabled={status.status === "pending"}
                className="w-full border  px-4 py-3 text-xs transition-colors bg-muted/50 border-border text-muted-foreground hover:bg-muted/50 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer font-mono uppercase tracking-wider"
              >
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-2 justify-end">
            <button
              ...
              className="px-4 py-2 text-xs border border-border  hover:bg-muted transition-colors cursor-pointer font-mono uppercase tracking-wider"
            >
              Cancel
            </button>
            <button
              onClick={confirmVote}
              className="px-4 py-2 text-xs bg-primary text-primary-foreground  hover:opacity-90 transition-opacity cursor-pointer font-mono uppercase tracking-wider"
            >
              Confirm Vote
            </button>
          </div>
