...
- **Adaptive governance** (May 2022): governance systems that can self-modify in response to changing conditions. The reform mandates (`Adopt_Mandates`, `Revoke_Mandates`, `Pause_Mandates`) implement adaptive capacity.
