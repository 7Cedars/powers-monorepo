---
title: The Powers Protocol
description: Role-restricted governance protocol for DAOs
---
...
- **Admin**: `PowersRoleSet`, `RoleLabel`, `MandateAdopted`, `MandateRevoked`, `BlacklistSet`, `Powers__Initialized`
