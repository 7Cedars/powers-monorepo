...
<CardGrid>
  ...
  <Card title="Separation of Powers" icon="approve-check">
  ...
  <Card title="Beyond Institutional Reach" icon="rocket">
  ...
  <Card title="Multi-Party Coordination" icon="information">
