---
title: "SafeAllowance_Action"
description: "Documentation for the SafeAllowance_Action integration mandate, which allows the Powers contract to execute specific functions on the Safe Allowance Module, acting as an authorized delegate."
---
