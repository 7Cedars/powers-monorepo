---
title: "Safe_ExecTransaction"
description: "Documentation for the Safe_ExecTransaction integration mandate, which enables the Powers contract to execute arbitrary transactions through a Gnosis Safe it owns."
---
