---
title: "ElectionList_Nominate"
description: "Documentation for the ElectionList_Nominate integration mandate, which allows users to self-nominate (or withdraw) from a specific election managed by the ElectionList contract."
---
