---
title: "ElectionList_CreateVoteMandate"
description: "Documentation for the ElectionList_CreateVoteMandate integration mandate, which creates a new vote mandate for a specific election event."
---
