---
title: "PowersFactory_AssignRole"
description: "Documentation for the PowersFactory_AssignRole integration mandate, which assigns a specific role in the Powers organization to an address returned by a parent action."
---
