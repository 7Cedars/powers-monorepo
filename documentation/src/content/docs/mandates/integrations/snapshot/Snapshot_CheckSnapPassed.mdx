---
title: "Snapshot_CheckSnapPassed"
description: "Documentation for the Snapshot_CheckSnapPassed integration mandate, which uses Chainlink Functions to verify if a Snapshot proposal has concluded and if a specific choice has won."
---
