---
title: "Snapshot_CheckSnapExists"
description: "Documentation for the Snapshot_CheckSnapExists integration mandate, which uses Chainlink Functions to verify the existence and state of a Snapshot proposal, ensuring it is pending and includes a specific voting choice."
---

:::caution[Under Development]
This mandate is currently paused. The Solidity contract exists but is not active. Do not use in production.
:::
