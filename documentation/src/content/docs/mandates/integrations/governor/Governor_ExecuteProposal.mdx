---
title: "Governor_ExecuteProposal"
description: "Documentation for the Governor_ExecuteProposal integration mandate, which allows users to execute proposals on a configured Governor contract after they have succeeded in the governance process."
---
...
3. **Proposal Errors**
   - `"Governor_ExecuteProposal: Proposal not succeeded"` — the proposal exists but has not reached the Succeeded state.
