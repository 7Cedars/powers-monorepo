---
title: "Governor_CreateProposal"
description: "Documentation for the Governor_CreateProposal integration mandate, which allows users to create proposals on a configured Governor contract."
---
...
2. **Proposal Creation**
   ...
   - Creates and returns a call to `Governor.propose`.
