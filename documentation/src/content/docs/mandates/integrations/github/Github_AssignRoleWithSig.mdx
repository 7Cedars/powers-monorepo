...
description: "Documentation for the Github_AssignRoleWithSig integration mandate, which assigns a role to a user after successful GitHub commit verification via Github_ClaimRoleWithSig."
---
