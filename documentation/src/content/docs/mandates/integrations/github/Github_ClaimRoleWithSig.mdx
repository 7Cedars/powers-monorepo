...
description: "Documentation for the Github_ClaimRoleWithSig integration mandate, which allows users to claim a role by proving ownership of a GitHub commit through signature verification using Chainlink Functions."
---
