---
title: "BespokeAction_Advanced"
description: "BespokeAction_Advanced is an executive mandate that enables the execution of a custom function call on a target contract, allowing for complex parameter composition."
---
