---
title: "BespokeAction_OnReturnValue"
description: "BespokeAction_OnReturnValue is an executive mandate that chains actions together. It retrieves the return data from a previously executed mandate and uses it as a parameter for a new function call."
---
...
3.  **Execution**
    ...
    *   If `TargetContract` is set to `address(0)`, the call is directed at the Powers contract itself.
