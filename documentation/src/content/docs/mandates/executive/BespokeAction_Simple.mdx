---
title: "BespokeAction_Simple"
description: "BespokeAction_Simple is an executive mandate that enables the execution of a single, predefined function call to a target contract."
---
