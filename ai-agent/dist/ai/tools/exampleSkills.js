 ...
 */
export const assessProposalImpact = {
    name: 'assess_proposal_impact',
    description: 'Fetch a governance proposal document (Markdown) from the given URL and assess it against impact criteria. ' +
 ...
 * Add via POST /api/session/:id/skills with this object as the body.
 */
export const assessProposalFinancial = {
    name: 'assess_proposal_financial',
    description: 'Fetch a governance proposal document (Markdown) from the given URL and assess it against financial viability criteria. ' +
