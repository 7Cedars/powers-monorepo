...
contract ZKPassport_PowersRegistry is IZKPassport_PowersRegistry {
    ...
    //                     CONSTRUCTOR                          //
    //////////////////////////////////////////////////////////////
    constructor(address _zkPassportVerifier, address _zkPassportHelper, string memory _domain, string memory _scope) {
    ...
    function registerProof(ProofVerificationParams calldata params, bool isIDCard)
        external
        returns (bytes32 identifier)
    {
        ...
        // 3. Verify uniqueness
        require(
            identifierAccounts[mem.uniqueIdentifier] == address(0)
        ...
        bool hasFacematch;
        try zkPassportHelper.isFaceMatchVerified(FaceMatchMode.REGULAR, OS.ANY, params.committedInputs) returns (
            bool facematchResult
        ) {
        ...
        identifierAccounts[mem.uniqueIdentifier] = msg.sender;
        identifierToDisclosedData[mem.uniqueIdentifier] =
            Disclosed({ disclosedData: disclosedData, isFacematched: hasFacematch, timestamp: mem.proofTimestamp });
    ...
    function deleteProof() external {
        ...
        require(identifierAccounts[identifier] == msg.sender, "Identifier not registered to caller");
