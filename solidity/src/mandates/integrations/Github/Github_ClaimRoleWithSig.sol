 ...
 */
contract Github_ClaimRoleWithSig is AsyncMandate, FunctionsClient {
    ...
    function fulfillRequest(bytes32 requestId, bytes memory response, bytes memory err) internal override {
        ...
        // Call _replyPowers to update the action state in Powers
